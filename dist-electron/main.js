...
ipcMain$1.handle("electron-store-set", (_, key, value) => {
  store.set(key, value);
  return true;
});
ipcMain$1.handle("electron-store-delete", (_, key) => {
  store.delete(key);
  return true;
});
ipcMain$1.handle("electron-store-clear", () => {
  store.clear();
  return true;
});
ipcMain$1.handle("electron-store-has", (_, key) => {
